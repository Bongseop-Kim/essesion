...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["run_id"],
            ["seamless_generation_logs.id"],
            name=op.f("fk_design_examples_run_id_seamless_generation_logs"),
            ondelete="RESTRICT",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_design_examples")),
        sa.UniqueConstraint("run_id", name=op.f("uq_design_examples_run_id")),
    )
    op.create_index(
        "ix_design_examples_published_ordinal",
        "design_examples",
        ["published", "ordinal"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_design_examples_published_ordinal", table_name="design_examples")
    op.drop_table("design_examples")
