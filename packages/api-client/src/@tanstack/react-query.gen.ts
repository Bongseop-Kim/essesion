...
/**
 * Branch Design Session
 *
 * Start a new linear conversation from any successful candidate in an owned session.
 */
export const branchDesignSessionMutation = (options?: Partial<Options<BranchDesignSessionData>>): UseMutationOptions<BranchDesignSessionResponse, BranchDesignSessionError, Options<BranchDesignSessionData>> => {
    const mutationOptions: UseMutationOptions<BranchDesignSessionResponse, BranchDesignSessionError, Options<BranchDesignSessionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await branchDesignSession({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * Reroll Design
 */
export const rerollDesignMutation = (options?: Partial<Options<RerollDesignData>>): UseMutationOptions<RerollDesignResponse, RerollDesignError, Options<RerollDesignData>> => {
    const mutationOptions: UseMutationOptions<RerollDesignResponse, RerollDesignError, Options<RerollDesignData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await rerollDesign({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Select Design Candidate
 */
export const selectDesignCandidateMutation = (options?: Partial<Options<SelectDesignCandidateData>>): UseMutationOptions<SelectDesignCandidateResponse, SelectDesignCandidateError, Options<SelectDesignCandidateData>> => {
    const mutationOptions: UseMutationOptions<SelectDesignCandidateResponse, SelectDesignCandidateError, Options<SelectDesignCandidateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await selectDesignCandidate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
