...
- [x] 2026-07-22 `ci/py`·`ci/osv-scan` 복구 — *Ruff 포맷 드리프트 6건을 정리하고 `pyasn1` 0.6.4·`sharp` 0.35.0으로 취약 전이 의존성을 갱신했다. Ruff check/format·Pyright·pytest 840건과 OSV Scanner v2.3.8 재검증을 통과했다.*
