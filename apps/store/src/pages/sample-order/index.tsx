...
export function SampleOrderPage() {
  ...
  return (
    <>
      <PageMeta
        title="샘플 제작 주문 | 영선산업"
        description="단체 주문 전 원단과 봉제 품질을 확인할 수 있는 넥타이 샘플을 제작해 드립니다."
        path="/sample-order"
      />
      <ContentLayout
        ...
        sidebar={
          <SummaryCard.Root>
            ...
            <Callout
              title="샘플 안내"
              description="대량 제작 전에 원단과 봉제 품질을 확인할 수 있습니다. 제주·도서산간은 추가 배송비가 발생할 수 있으며, 제작 시작 후에는 진행 단계와 실제 발생 비용에 따라 취소·환불이 제한될 수 있습니다. 샘플 결제 완료 시 본 주문 할인 쿠폰이 발급됩니다."
            />
          </SummaryCard.Root>
        }
        actionBar={
