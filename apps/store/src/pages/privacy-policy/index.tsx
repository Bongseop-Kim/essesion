      ...
      <PolicySection title="5. 개인정보 처리업무의 위탁 및 국외 처리">
        ...
        <PolicyList
          items={[
            ...
            "OpenAI: AI 디자인 저작·아이디어·텍스트 유사도와 사용자가 명시적으로 요청한 새 모티프 생성 프롬프트 처리",
        ...
        <PolicyList
          items={[
            ...
            "OpenAI, L.L.C.(미국): AI 디자인 저작·아이디어 생성, 텍스트 유사도 계산과 사용자가 명시적으로 요청한 새 모티프 생성을 위해 사용자가 입력한 프롬프트와 서비스가 선택한 모티프·예시의 텍스트 정보를 처리합니다. 사용자 업로드 이미지 파일은 전송하지 않습니다. API 입력·출력은 기본적으로 모델 학습에 사용되지 않습니다. 부정 사용 감시 로그는 원칙적으로 최대 30일 보관될 수 있으며 법령 준수·보안상 예외가 적용될 수 있습니다. 연락처: privacy@openai.com",
          ]}
        />
      </PolicySection>
