      ...
      <PolicySection title="5. 개인정보 처리업무의 위탁 및 국외 처리">
        ...
        <PolicyList
          items={[
            ...
            "Recraft, Inc.(미국): 사용자가 새 모티프 생성을 명시적으로 요청한 경우 해당 텍스트 프롬프트를 처리하며, 참조 이미지 파일은 전송하지 않습니다. API 입력·출력은 모델 학습에 사용되지 않으며 생성 후 24시간이 지나면 삭제됩니다. 연락처: recraft.ai/legal/privacy",
          ]}
        />
      </PolicySection>
