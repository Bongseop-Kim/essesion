...
function AuthoredExampleActions({
  ...
  return (
    <VStack gap="x5" alignItems="stretch">
      ...
      <AdminCard
        title="직접 작성 시범 삭제"
        description="authored 시범만 영구 삭제할 수 있습니다. 활성 상태라면 검색 풀에서도 즉시 제거됩니다."
      >
        <HStack>
          <ActionButton
      ...
      <AlertDialog
        ...
        description="삭제하면 되돌릴 수 없으며 활성 시범인 경우 다음 검색부터 즉시 제외됩니다."
        primaryActionProps={{
          children: "영구 삭제",
          variant: "criticalSolid",
          onClick: () =>
            deleteMutation.mutate({ path: { example_id: example.id } }),
        }}
        secondaryActionProps={{ children: "취소" }}
      />
    </VStack>
